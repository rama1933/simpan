      ...
      <div class="w-full mx-auto py-6 px-6">
        <div class="px-0">
          ...
          <div class="mb-6 flex items-center justify-between">
            <Link :href="route('knowledge.index')" class="text-brand-700 hover:text-brand-800 mr-4">
          ...
          <Form ref="formRef" :validation-schema="schema" @submit="onSubmit" v-slot="{ meta, values }" class="space-y-6">
            ...
            <div class="sticky bottom-0 inset-x-0 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/80 border-t border-gray-200 px-6 py-4 flex justify-end gap-3 shadow-lg">
              <Link :href="route('knowledge.index')" class="px-4 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-500">Batal</Link>
