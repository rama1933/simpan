...
Route::prefix('knowledge')->name('knowledge.')->group(function () {
    ...
    Route::post('/{knowledge}/verify', [KnowledgeController::class, 'verify'])->middleware(['auth','role:Admin'])->name('verify');
    Route::post('/{knowledge}/unverify', [KnowledgeController::class, 'unverify'])->middleware(['auth','role:Admin'])->name('unverify');
